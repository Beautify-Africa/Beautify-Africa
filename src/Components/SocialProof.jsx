...
const SOCIAL_PROOF_CONTENT = {
  ...
  avatars: [
    { id: 1, src: 'https://picsum.photos/id/1027/40/40', alt: 'Happy customer' },
    { id: 2, src: 'https://picsum.photos/id/1012/40/40', alt: 'Happy customer' },
    { id: 3, src: 'https://picsum.photos/id/1011/40/40', alt: 'Happy customer' },
  ],
  starCount: 5,
};
