...
export default function ShopFilterBar({
  ...
  const skinTypeOptions =
    Array.isArray(skinTypes) && skinTypes.length > 0 ? skinTypes : [ALL_FILTER_OPTION];
  const sortableOptions =
    Array.isArray(sortOptions) && sortOptions.length > 0 ? sortOptions : SORT_OPTIONS;
    ...
    <div className="mb-10" ref={filterRef}>
      ...
      <div className="flex items-center justify-between mt-3 px-1">
        <p className="text-xs text-stone-600">
          <span className="font-medium text-stone-700">{resultCount}</span> product
