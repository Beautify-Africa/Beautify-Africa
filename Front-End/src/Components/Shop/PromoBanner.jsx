    ...
    >
        ...
        {PROMO_BANNERS.map((banner, index) =>
          (() => {
            ...
            return (
              <div
                key={banner.id}
                className={`absolute inset-0 bg-stone-900 transition-all duration-500 ease-in-out ${
                  index === activeIndex
              ...
              >
                ...
                <div className="absolute inset-0">
                  ...
                  />
                  <div
                    className={`absolute inset-0 bg-gradient-to-r ${banner.gradient} opacity-80`}
                  />
                </div>
      ...
      {!isPaused && (
        <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-white/10 z-20">
          <div className="h-full bg-white/50 animate-banner-progress" key={activeIndex} />
        </div>
      )}
    </div>
  );
