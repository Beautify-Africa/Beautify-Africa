...
export default function ProfileOrdersSection({
  ...
  return (
    <section className="lg:col-span-7">
      ...
      {lastSyncedAt ? (
        <p className="mb-5 text-[10px] font-bold uppercase tracking-[0.18em] text-stone-400">
          Last synced:{' '}
      ...
      {isLoadingOrders ? (
        ...
        <div className="rounded-sm border border-stone-200 bg-white p-12 text-center shadow-sm">
          ...
          <p className="mx-auto mb-6 max-w-sm text-sm text-stone-500">
            You have not placed any orders with Beautify Africa yet. Discover our latest
            formulations in the shop.
          </p>
          <Link
            to="/shop"
