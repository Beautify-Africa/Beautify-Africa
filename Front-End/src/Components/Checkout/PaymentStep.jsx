  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex gap-2 mb-4">
        <span className="px-2 py-1 text-[9px] font-bold border border-stone-200 rounded text-stone-400">
          Visa
        </span>
        <span className="px-2 py-1 text-[9px] font-bold border border-stone-200 rounded text-stone-400">
          Mastercard
      ...
      <div className="bg-stone-50 border border-stone-200 p-4 mt-4 rounded-sm text-[10px] text-stone-500 leading-relaxed font-mono">
        ...
        <p>
          Card Number: <span className="font-bold text-stone-800">4242 4242 4242 4242</span>
        </p>
        <p>
          Expiry: <span className="font-bold text-stone-800">Any future date</span>
        </p>
        <p>
          CVC: <span className="font-bold text-stone-800">Any 3 digit</span>
        </p>
      </div>
