              ...
              {require2FA && (
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <label
                      htmlFor="admin-2fa"
                      className="block text-[11px] font-bold uppercase tracking-[0.16em] text-amber-400"
                    >
                  ...
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-amber-400">
                      <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A13.916 13.916 0 008 11a4 4 0 118 0c0 1.017-.07 2.019-.203 3m-2.118 6.844A21.88 21.88 0 0015.171 17m3.839 1.132c.645-2.266.99-4.659.99-7.132A8 8 0 004 11m0 0a8 8 0 00.99 7.132" />
                      </svg>
                    </div>
                    <input
                      id="admin-2fa"
                      ...
                      className="w-full rounded-xl border border-amber-500/50 bg-amber-950/20 pl-10 pr-4 py-3 text-sm text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 transition-all font-mono tracking-wider"
                    />
                  </div>
                  <p className="text-[11px] text-zinc-400">
                    Enter the 6-digit TOTP code generated by Google Authenticator, or an emergency recovery code.
                  </p>
                </div>
              )}
                ...
                >
                  <div className="px-6 py-3.5 rounded-[11px] bg-zinc-950/40 backdrop-blur-sm group-hover:bg-transparent transition-colors flex items-center justify-center gap-2">
                    {loading ? (
                      ...
                      <>
                        <span>{require2FA ? 'Verify 2FA & Authorize' : 'Authorize Session'}</span>
